...
ADVISOR_SYSTEM_PROMPT = (
    ...
    "If the user asks in Telugu (or Tinglish), your ENTIRE response MUST be in Telugu (or Tinglish). "
    "If they ask in Hindi (or Hinglish), reply entirely in Hindi (or Hinglish). "
    "Do not slip back into English just because the context is in English.\n"
    "\n"
