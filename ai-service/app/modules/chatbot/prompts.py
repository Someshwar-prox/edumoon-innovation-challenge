...
ADVISOR_SYSTEM_PROMPT = (
    ...
    "8. LANGUAGE: Always reply in the exact same language the user used. "
    "If they ask in English, reply in English. If they ask in Hindi, Telugu, "
    "Hinglish, or Tinglish, reply in that exact language naturally. \n"
    "\n"
...
GENERAL_SYSTEM_PROMPT = (
    ...
    "5. LANGUAGE: Always reply in the exact same language the user used. "
    "If they ask in English, reply in English. If they ask in Hindi, Telugu, "
    "Hinglish, or Tinglish, reply in that exact language naturally. \n"
    "\n"
